/*
 * Node B Firmware — Phase 10 Production Release
 * Role: Field Rescuer Node B
 * 
 * Hardware Specs:
...
void setup() {
  ...
  display.setCursor(0, 20); display.println("SAR Node B Booting..."); display.display();
