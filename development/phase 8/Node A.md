// ===========================================================================
//  PHASE 7  -  RANGE, GPS & NEW UI  -  NODE A
...
//
//  PHASE 8 ADDITION - the mesh now has a fourth member, the Rover ("R"), a
//  mobile node with motors + an ultrasonic sensor (development/phase 8/
//  Node Rover.md). This node's only change is relaying the Rover's ROVER:
//  telemetry broadcast (mode/obstacle/battery) like any other broadcast type
//  (SOS/RPT) - added to `forwardable` and given a forward-only branch in
//  handleOneRx() - so the Rover's status reaches the Pi dashboard even when
//  it is out of the Pi's direct range and this node (or B/C) is bridging.
//  Everything else here is byte-for-byte Phase 7.
// ===========================================================================
