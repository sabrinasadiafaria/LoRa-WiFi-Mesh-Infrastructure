#!/usr/bin/env python3
"""
SAR Command Centre - Phase 9 (FINAL) entry point.
...
This is the same codebase as development/pi/main.py - the canonical copy
under development/pi/ is the one that actually runs day-to-day; this
phase 9 copy exists for the Phase 9 integration run (so the tester can
flash the phase 9 nodes and run the phase 9 Pi together without
worrying about which development/pi/ version they have checked out).
"""
