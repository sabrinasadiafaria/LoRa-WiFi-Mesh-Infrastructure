// ===========================================================================
//  PHASE 1  -  SHARED CORE  -  NODE A
//  ESP32 + LoRa SX1278 (433 MHz) + 1.3" SH1106 OLED
//
...
//                             h = help
//
//  If your Node A has the 0.96" SSD1306 instead of the 1.3" SH1106, use the
//  Node B sketch and change MY_ID to "A".
// ===========================================================================
