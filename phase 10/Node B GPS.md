...
unsigned long lastGpsBroadcast = 2000; // Offset broadcast to prevent RF collision
...
void updateOLED() {
  ...
  display.println("--- NODE B (RAW GPS) ---");
...
void setup() {
  ...
  Serial.println("Node B (ESP32 + RAW NEO-M8N GPS) Ready");
}
